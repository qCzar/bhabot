...
describe ("meetup creator link", () => {
   it ("uses the configured form root", () => {
      expect (meetupCreatorUrl ("https://qczar.github.io/bhabot/"))
         .toBe ("https://qczar.github.io/bhabot/");
   });
   ...
   it ("tells the user how to submit the generated options", () => {
      ...
      expect (message).toContain ("[Open the meetup creator](https://qczar.github.io/bhabot/)");
