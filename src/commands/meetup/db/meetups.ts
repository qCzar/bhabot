...
export type Schema = {
  ...
  /** Maximum number of RSVPs allowed. Undefined means no limit */
  maxRsvp?: number;

  /** ISO string deadline for RSVPs. Undefined means no deadline */
  rsvpDeadline?: string;

  /** Duration of the meetup in hours. Defaults to 2 */
  duration?: number;
